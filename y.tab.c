...
#define MUL 260
#define POWER 261
#define PAREN_OPEN 262
#define PAREN_CLOSE 263
#define NEWLINE 264
#define X 265
#define NUMBER 266
...
{
       0,    65,    65,    66,    72,   124,   130,   136,   150,   156,
     176,   182,   183,   197,   208,   218,   228,   236,   242
};
#endif
...
{
  "$end", "error", "$undefined", "ADD", "SUB", "MUL", "POWER",
  "PAREN_OPEN", "PAREN_CLOSE", "NEWLINE", "X", "NUMBER", "$accept",
  "program", "quest", "expr", "tm", "mon", "intopt", "powopt", YY_NULLPTR
};
#endif
...
{
      15,    14,    16,    -9,    -8,     5,    -3,     6,     4,    -9,
       3,     4,    25,    -9,    -9,    14,    14,    -9,    16,     8,
      -9,     4,     4,    27,     1,    -9,    -9,    -9
};
...
{
      16,    16,    16,     5,    14,     0,     3,     0,     6,    10,
       0,     7,     0,     1,     2,    16,    16,     4,    16,    18,
      11,     8,     9,     0,     0,    13,    12,    17
};
...
{
      12,     1,   -15,    11,     2,    13,     3,   -16,     4,    15,
      16,    18,    27,    19,    24,    17,    23,    21,    22,     1,
       1,     2,     2,     2,     3,     4,     4,     4,    15,    16,
      15,    16,    14,    20,     0,    26
};

static const yytype_int8 yycheck[] =
{
       2,     4,    10,     1,     7,     0,     9,    10,    11,     3,
       4,     7,    11,    10,     6,     9,    18,    15,    16,     4,
       4,     7,     7,     7,     9,    11,    11,    11,     3,     4,
       3,     4,     6,     8,    -1,     8
};
...
{
       0,     4,     7,     9,    11,    13,    14,    15,    16,    17,
      18,    16,    15,     0,    13,     3,     4,     9,     7,    10,
       8,    16,    16,    15,     6,    19,     8,    11
};
...
#line 65 "calc.y" /* yacc.c:1646  */
    {free((yyvsp[-1].mass_and_size).mass_of_ints);}
...
#line 73 "calc.y" /* yacc.c:1646  */
    {
	char* r=NULL;
	poly_to_string((yyvsp[-1].mass_and_size),&r);
	semantic=0;
	//printf("%s\n",r);
...
#line 131 "calc.y" /* yacc.c:1646  */
    {
	     ...
	     (yyval.mass_and_size)=(yyvsp[0].mass_and_size);
...
#line 137 "calc.y" /* yacc.c:1646  */
    {
	   struct Int temp;
	   temp.mass_of_ints=(int*)calloc((yyvsp[0].mass_and_size).size_of_array,sizeof(int));
	   memcpy(temp.mass_of_ints,(yyvsp[0].mass_and_size).mass_of_ints,(yyvsp[0].mass_and_size).size_of_array*sizeof(int));
	   temp.size_of_array=(yyvsp[0].mass_and_size).size_of_array; 
	   //make_negative(&temp);
		int i=0;
...
#line 151 "calc.y" /* yacc.c:1646  */
    {
	   ...
	   (yyval.mass_and_size)=polyadd(&(yyvsp[-2].mass_and_size),&(yyvsp[0].mass_and_size));
...
#line 157 "calc.y" /* yacc.c:1646  */
	...
	temp.size_of_array=(yyvsp[0].mass_and_size).size_of_array;
	 ...
	 (yyval.mass_and_size)=polyadd(&(yyvsp[-2].mass_and_size),&temp); 
...
#line 182 "calc.y" /* yacc.c:1646  */
    { (yyval.mass_and_size)=(yyvsp[-1].mass_and_size); }
...
#line 184 "calc.y" /* yacc.c:1646  */
	...
	polymult(&temp,(yyvsp[-3].mass_and_size),(yyvsp[-1].mass_and_size));
	(yyval.mass_and_size).size_of_array=temp.size_of_array;
	(yyval.mass_and_size).mass_of_ints=(int*)realloc(temp.mass_of_ints,(sizeof(int)*temp.size_of_array));
	memcpy((yyval.mass_and_size).mass_of_ints,temp.mass_of_ints,sizeof(int)*temp.size_of_array);
...
#line 198 "calc.y" /* yacc.c:1646  */
    {
		...
		(yyval.mass_and_size).mass_of_ints=NULL;//(int*)calloc(1,sizeof(int));//??
		(yyval.mass_and_size).size_of_array=0;	

		safeadd(&(yyval.mass_and_size),(yyvsp[0].mass_and_size),(yyvsp[-2].mass_and_size));
...
#line 209 "calc.y" /* yacc.c:1646  */
    {
		(yyval.mass_and_size).mass_of_ints=(int*)calloc(1,sizeof(int));
		(yyval.mass_and_size).size_of_array++;	
		(yyval.mass_and_size).mass_of_ints[0]=(yyvsp[0].num);
...
#line 228 "calc.y" /* yacc.c:1646  */
    {
			(yyval.mass_and_size).mass_of_ints=(int*)calloc(1,sizeof(int));
			(yyval.mass_and_size).size_of_array++;	
			(yyval.mass_and_size).mass_of_ints[0]=1;
